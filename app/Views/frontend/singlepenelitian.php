    ...
    <body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-offset="100">
            ...
            <section id="blog" class="blog">
                <div class="container" data-aos="fade-up">
                    <div class="row">
                        <div class="col-lg-8 entries">
                            <article class="entry entry-single">
                                <div class="entry-img" style="text-align:center;">
                                    <img src="<?php echo $thumb; ?>" alt="thumbnail" class="img-fluid" style="width: 80%; height: auto;">
                                </div>
                                ...
                                <div class="entry-meta">
                                    <ul>
                                        <li class="d-flex align-items-center">
                                            <img src="<?php echo $foto_penulis; ?>" alt="foto" class="img-rounded" style="width: 60px; height: auto;">
                                        </li>
                                ...
                                <div class="entry-footer">
                                    ...
                                    <ul class="tags">
                                        <?php
                                        $kunci = explode(",", $keyword);
                                        for($i=0; $i<count($kunci); $i++){
                                            ?>
                                        <li><a href="#"><?php echo trim($kunci[$i]); ?></a></li>
                                            <?php
                                        }
                                        ?>
                                    </ul>
                        ...
                        <div class="col-lg-4">
                            <div class="sidebar">
                                <h3 class="sidebar-title">DOKUMEN MATERI</h3>
        ...
        <footer id="footer" class="footer">
            ...
            <div class="container">
                ...
                <div class="credits">
                    Created by @Disinfolahta Kormar</a>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            function unduh(kode, link){
                var sandi = prompt("Masukkan sandi dokumen ?", "");
